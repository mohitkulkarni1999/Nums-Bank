    ...
    <header className="sticky top-0 z-40 w-full bg-white dark:bg-navy-900 border-b border-slate-100 dark:border-navy-800 shadow-sm flex items-center justify-between px-6 py-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="min-w-[44px] min-h-[44px] p-2.5 rounded-xl border border-slate-100 dark:border-navy-800 hover:bg-slate-50 dark:hover:bg-navy-800 text-slate-500 dark:text-slate-400 transition-all active:scale-95 flex items-center justify-center"
        >
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative min-w-[44px] min-h-[44px] p-2.5 rounded-xl border border-slate-100 dark:border-navy-800 hover:bg-slate-50 dark:hover:bg-navy-800 text-slate-500 dark:text-slate-400 transition-all active:scale-95 flex items-center justify-center"
          >
            <Bell className="w-5 h-5" />
            {mockNotifications.some(n => n.unread) && (
              <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white dark:border-navy-900 animate-pulse" />
            )}
          </button>
        ...
        <div className="flex items-center gap-3 pl-3 border-l border-slate-100 dark:border-navy-800">
          <button
            onClick={() => navigate('/profile')}
            aria-label="Go to profile"
            className="min-w-[44px] min-h-[44px] flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-500 to-[#FFD700] text-white font-bold select-none shadow-md hover:opacity-90 transition-opacity"
          >
            {user?.fullName
          ...
          <button
            ...
            aria-label="Logout"
            className="min-w-[44px] min-h-[44px] p-2.5 rounded-xl border border-transparent hover:border-red-500/20 hover:bg-red-50 dark:hover:bg-red-950/20 text-slate-400 hover:text-red-500 transition-all flex items-center justify-center"
          >
